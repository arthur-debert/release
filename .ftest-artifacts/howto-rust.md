# release-core how-to — this repo (Kind: rust-cli)
...
## The five verbs
- **lint / quality gate:** `release-core gate` (the one quality gate — runs clippy, fmt, shellcheck, markdownlint, yamllint: the SAME set CI runs)
