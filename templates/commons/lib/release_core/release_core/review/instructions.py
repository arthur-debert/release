...
data) is the generic single-repo review guidance: the four review dimensions,
the test-quality dimensions, the world-class measurement model, and "output a
ranked list of findings." It is provider-neutral — it names no backend and no
specific project.
...
def default_instructions() -> str:
    ...
    return (
        importlib.resources.files("release_core.review")
