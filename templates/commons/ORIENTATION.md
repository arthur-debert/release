...
ad-hoc `gh api` calls. (Source of record: [the dev-cycle model upstream](https://github.com/arthur-debert/release/blob/main/docs/dev-cycle.lex) — you don't need to fetch it; the cycle above is the operating copy.)
