...
@test "dogfood: synced distributed tools pass the unified gate (shim skipped)" {
  ...
  # The synced consumer's bin/ holds the distributed tools (changelog Python
  # shim, setup-dev-env.sh, vendored share/, ...). The unified gate must pass
  # over them — non-shell falls out by content.
