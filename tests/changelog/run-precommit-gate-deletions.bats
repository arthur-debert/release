...
# failing the release. The fix: collect with --diff-filter=ACMR so
# deletions are excluded from the gate's file list (the deletion is still
# committed via the staged index regardless).
