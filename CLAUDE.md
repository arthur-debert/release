...
- **The gate is ONE definition, run everywhere — never reimplemented.**
  ...
  required check. **WS3 (#524):** in a *consumer* the gate definition + tool
  ...
  `release-core gate --hook`. (Release's OWN repo keeps a hand-authored root
